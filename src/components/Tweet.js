...
export const Tweet = props => {
  ...
  const {name, handle, text, avatar, date} = props;

  return(
    <article>

      {name && handle && text && avatar && date &&
      ...
      <>
        <header className="tweets-header">
          ...
          <p className="username">{props.handle}</p>
        </header>
        <p className="tweet-body">{props.text}</p>
        <footer className="tweets-footer">
          <p className="date-stamp">{props.date}</p>
